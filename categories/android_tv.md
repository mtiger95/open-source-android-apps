...
| :--- | :--- | :---: | :---: | :---: | :---: |
| [**Jellyfin**](https://github.com/jellyfin/jellyfin-androidtv) | A client for the Jellyfin media server, designed for Android TV and Fire TV devices. | `Kotlin` | `GPL-2.0` | 4.5k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.jellyfin.androidtv) |
| [**SmartTubeNext**](https://github.com/yuliskov/SmartTube) | An ad-free client for watching YouTube on Android TV boxes, with a built-in updater. | `Java` | `MIT` | 32.9k | [![Download](https://img.shields.io/badge/Download-APK-blue)](https://github.com/yuliskov/SmartTube) |
