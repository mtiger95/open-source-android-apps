...
| [**Android-Ganhuo**](https://github.com/ganhuo/Android-Ganhuo) | The official Android client for the Chinese tech content aggregator ganhuo.io. | `Java` | Not specified | 288 | — |
...
| [**GitHot**](https://github.com/andyiac/githot) | An app to help you find the world's most popular projects and developers on GitHub. | `Java` | `Apache-2.0` | 377 | — |
| [**Hacker News (by manmal)**](https://github.com/manmal/hn-android) | A simple and clean Hacker News client for Android. | `Java` | `Apache-2.0` | 497 | — |
...
| [**KuaiHu**](https://github.com/iKrelve/KuaiHu) | A third-party client for the popular Chinese news aggregator zhihu.com. | `Java` | `Apache-2.0` | 686 | — |
| [**Leisure**](https://github.com/MummyDing/Leisure) | An app that aggregates content from Zhihu Daily, Guokr, and Douban Books. | `Java` | `LGPL-3.0` | 546 | [![Download](https://img.shields.io/badge/Download-APK-blue)](http://coolapk.com/apk/com.mummyding.app.leisure) |
...
| [**RedReader**](https://github.com/QuantumBadger/RedReader) | A fast, feature-rich, and accessibility-focused Reddit client. | `Java` | `GPL-3.0` | 2.6k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.quantumbadger.redreader) |
...
| [**Wikipedia**](https://github.com/wikimedia/apps-android-wikipedia) | The official open-source Wikipedia application for Android. | `Kotlin` | `Apache-2.0` | 3.0k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.wikipedia) |
| [**Yahnac**](https://github.com/malmstein/yahnac) | "Yet Another Hacker News Android Client." | `Java` | `Apache-2.0` | 634 | — |
