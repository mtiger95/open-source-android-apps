...
| [**Book Dash**](https://github.com/bookdash/bookdash-android-app) | An app to download free children's books in different languages from the NPO. | `Java` | `Apache-2.0` | 711 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.bookdash.android) |
...
| [**GitHot**](https://github.com/andyiac/githot) | An app to help you find the world's most popular projects and developers on GitHub. | `Java` | `Apache-2.0` | 376 | — |
...
| [**Leisure**](https://github.com/MummyDing/Leisure) | An app that aggregates content from Zhihu Daily, Guokr, and Douban Books. | `Java` | `LGPL-3.0` | 547 | [![Download](https://img.shields.io/badge/Download-APK-blue)](http://coolapk.com/apk/com.mummyding.app.leisure) |
