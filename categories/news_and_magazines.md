...
| [**KuaiHu**](https://github.com/iKrelve/KuaiHu) | A third-party client for the popular Chinese news aggregator zhihu.com. | `Java` | `Apache-2.0` | 696 | — |
...
| [**MVVM Hacker News**](https://github.com/hitherejoe/MVVM_Hacker_News) | An experimental Hacker News app using the MVVM pattern and Data Binding library. | `Java` | `Apache-2.0` | 878 | — |
...
| [**RedReader**](https://github.com/QuantumBadger/RedReader) | A fast, feature-rich, and accessibility-focused Reddit client. | `Java` | `GPL-3.0` | 2.4k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.quantumbadger.redreader) |
...
| [**Wikipedia**](https://github.com/wikimedia/apps-android-wikipedia) | The official open-source Wikipedia application for Android. | `Kotlin` | `Apache-2.0` | 2.8k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.wikipedia) |
