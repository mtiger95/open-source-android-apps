...
| :--- | :--- | :---: | :---: | :---: | :---: |
| [**AnkiDroid**](https://github.com/ankidroid/Anki-Android) | A powerful, intelligent flashcard app that uses spaced repetition. | `Kotlin` | `GPL-3.0` | 10.5k | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=com.ichi2.anki) |
...
| [**ForgetMeNot**](https://github.com/tema6120/ForgetMeNot) | A simple and user-friendly flashcard application for Android. | `Kotlin` | `GPL-3.0` | 419 | — |
| [**GivesMeHope**](https://github.com/jparkie/GivesMeHopeAndroidClient) | An unofficial Android client for the Gives Me Hope website for educational purposes. | `Java` | `MIT` | 216 | — |
...
| [**LeeCo**](https://github.com/Nightonke/LeeCo) | An app for algorithm problems, solutions, and discussions from LeetCode. | `Java` | `Apache-2.0` | 500 | [![Download](https://img.shields.io/badge/Download-APK-blue)](https://github.com/Nightonke/LeeCo) |
...
| [**Oppia**](https://github.com/oppia/oppia-android) | An interactive learning app that enables users to create and share lessons. | `Kotlin` | `Apache-2.0` | 386 | — |
...
| [**Stepik**](https://github.com/StepicOrg/stepik-android) | An app offering free, certificate-based online courses on various subjects. | `Kotlin` | `Apache-2.0` | 192 | [![Google Play](https://upload.wikimedia.org/wikipedia/commons/7/78/Google_Play_Store_badge_EN.svg)](https://play.google.com/store/apps/details?id=org.stepic.droid) |
